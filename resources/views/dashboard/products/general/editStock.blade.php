                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                              action="{{route('admin.products.general.updateStock')}}"
                                              method="POST"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="manage_stock" class="select2 form-control" id="manageStock">
                                                                <optgroup label="من فضلك أختر النوع ">
                                                                    <option value="1" @if($product->manage_stock == 1) selected @endif>Allowed</option>
                                                                    <option value="0" @if($product->manage_stock == 0) selected @endif>Not Allowed</option>
                                                                </optgroup>
                                                            </select>
                                                            @error('manage_stock')
                                                            <span class="text-danger"> {{$message}}</span>
