                                        ...
                                        <div class="images-container list_thumb">
                                            <div class="product-cover">
                                                <img class="js-qv-product-cover img-fluid"
                                                     src="{{asset('products/'.$product -> images[0] -> photo ?? '')}}"
                                                        ...
                                                        @foreach($product -> images as $image)
                                                            <div class="item thumb-container col-md-6 col-xs-12 pt-30">
                                                                <img class="img-fluid thumb js-thumb  selected "
                                                                     data-image-medium-src="{{asset('products/'.$image -> photo)}}"
                                                                     data-image-large-src="{{asset('products/'.$image -> photo)}}"
                                                                     src="{{$image -> photo}}"
                                                ...
                                                <a href="{{route('product.details',$_product -> slug)}}"
                                                   class="thumbnail product-thumbnail two-image">
                                                    <img class="img-fluid image-cover"
                                                         src="{{ isset($product -> images[0] -> photo )? asset( 'products/'.$product -> images[0] -> photo ) :'' }}"
                                                         alt=""
