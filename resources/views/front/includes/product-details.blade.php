                    ...
                    <div class="col-md-5 col-sm-5 divide-right">
                        <div class="images-container bottom_thumb">
                            <div class="product-cover">
                                <img class="js-qv-product-cover img-fluid" src="{{ isset($product -> images[0] -> photo )? asset( 'products/'.$product -> images[0] -> photo ) :'' }}" alt="" title="" style="width:100%;" itemprop="image">
